...
<%--<div class="switchable col-md-12 clear-padding">--%>
    <%--<div class="container">--%>
        <%--<div class="col-md-12 hotel-listing">--%>
            <%--&lt;%&ndash;//Todo Nouvelle page&ndash;%&gt;--%>
                    ...
                    try {
                        ...
                        else
                        {
                            ...
                            for(final Voyage myTripResult :myTripList)
                            {
                                ...
                                out.print(" <div class=\"media-action pull-right\">" + "<span class=\"price\"><small>Per Seat </small> $" + myTripResult.getDepartureDate() + "</span><br/>" + "<a href=\"/auth/AddToPanel?thisTrip=" + myTripResult.getIdVoyage()+ "\" class=\"button mini\"> Book</a>");
